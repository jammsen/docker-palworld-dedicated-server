...
# Ordering/comment template for the companion's settings export - copied onto
# the game volume at boot (see servermanager.sh) so the companion can keep its
# export line-compatible with this image's default.env for easy diffing
