...
while true; do
    ...
    if [ "${#server_pids[@]}" -ne 0 ]; then
        ...
        mapfile -t new_player_list < <(rconcil "ShowPlayers" | tail -n +2 | sed -E 's/,([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]|00000000),([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9])/,\2/g' )
        # No players
